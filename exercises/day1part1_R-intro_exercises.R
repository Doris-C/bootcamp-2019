...
#other ways: type read_csv("") use tab, available files in the current working directory will pop up
#### DATA MANIPULATION ####
...
# Hint: use prop.table() / input of prop.table() is table()
...
#or use subset subset(gapminder,subset=year==2007)
